    ...
    >
      <div className="p-4 bg-secondary rounded-2xl">
        ...
        <div className="flex items-center justify-between mt-2 bg-accent py-2 px-4 rounded-2xl">
          <p className="text-xs text-muted">Adinuba</p>
      ...
      <div className="p-4 rounded-2xl bg-accent mt-2 shadow-card-inset">
        <div className="flex items-center gap-2 border border-white/10 p-2 rounded-2xl">
          ...
          <div>
            ...
            <p className="text-xs text-muted">alimajames@gmail.com</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-2 rounded-2xl">
          ...
          <div>
            <h3 className="text-xs">Ndu Samuel</h3>
            <p className="text-xs text-muted">ndusamuel@gmail.com</p>
          </div>
        </div>
